...
gd_step = tf.train.GradientDescentOptimizer(1e-4).minimize(cross_entropy)
...
with tf.Session() as sess:
	...
	for i in range(NUM_STEPS):
		...
		if i%100==0:
			...
			#print("step {} , training accuracy {}",format(i,str(train_accuracy)))
		
		sess.run(gd_step,feed_dict={x:batch[0],y_:batch[1],keep_prob:0.5})
